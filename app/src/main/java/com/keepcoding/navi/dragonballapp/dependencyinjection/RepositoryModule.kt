...
import com.keepcoding.navi.dragonballapp.data.FavoriteRepositoryImp
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun bindFavoriteRepository(favoriteRepositoryImp: FavoriteRepositoryImp): FavoriteRepository
}